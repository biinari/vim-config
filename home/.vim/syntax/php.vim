...
" ================================================================
"
" Note: If you are having speed issues loading or editing PHP files, try
...
" PHP Syntax: magic classes (self/parent/static): {{{1

  syn cluster phpClClasses add=phpMagicClass
  syn keyword phpMagicClass contained self parent static
  ...
  if ! s:smart_semicolon
    ...
    if s:strict_blocks
      syn region phpStatementRegion extend keepend contained
            ...
            \ start=/\$\@<!\<throw\>/
            \ matchgroup=Error
              \ end=/[$>]\@<!\<\%(protected\|public\|private\|var\|final\|abstract\)\>/
              \ end=/}/ end=/)/ end=/\]/
              \ end=/,/
"              \ end=/;\_s*\%([.*\^|&,:!=<>]\|?>\@!\|\/[/*]\@!\|++\@!\|--\@!\)/
    else
...
" PHP Syntax: constants: {{{1
  ...
  " Magic Constants {{{2
    ...
    syn case match
    syn keyword	phpMagicConstant contained __DIR__ __LINE__ __FILE__ __FUNCTION__ __METHOD__ __NAMESPACE__ __CLASS__
    syn case ignore
  " }}}2
  ...
  " TODO: check these against the latest PHP manual
    ...
    syn keyword phpCoreConstant contained E_ERROR E_WARNING E_PARSE E_NOTICE E_STRICT E_DEPRECATED E_CORE_ERROR E_CORE_WARNING E_COMPILE_ERROR E_COMPILE_WARNING E_USER_ERROR E_USER_WARNING E_USER_NOTICE E_USER_DEPRECATED E_ALL
    ...
    syn keyword phpCoreConstant contained LIBXML_COMPACT LIBXML_DOTTED_VERSION LIBXML_DTDATTR LIBXML_DTDLOAD LIBXML_DTDVALID LIBXML_ERR_ERROR LIBXML_ERR_FATAL LIBXML_ERR_NONE LIBXML_LOADED_VERSION
    ...
    syn keyword phpCoreConstant contained PHP_PREFIX PHP_BINDIR PHP_CONFIG_FILE_PATH PHP_CONFIG_FILE_SCAN_DIR PHP_DATADIR PHP_EXTENSION_DIR PHP_LIBDIR PHP_LOCALSTATEDIR PHP_MAXPATHLEN PHP_SYSCONFDIR PHP_SHLIB_SUFFIX
    ...
    syn keyword phpCoreConstant contained PREG_BAG_UTF8_OFFSET_ERROR PREG_GREP_INVERT PREG_OFFSET_CAPTURE PREG_PATTERN_ORDER PREG_SET_ORDER PREG_SPLIT_DELIM_CAPTURE PREG_SPLIT_NO_EMPTY PREG_SPLIT_OFFSET_CAPTURE
...
" PHP Syntax: functions {{{1
  ...
  syn keyword phpFunctions contained array_change_key_case array_chunk array_combine array_count_values array_diff_assoc array_diff_key array_diff_uassoc array_diff_ukey array_diff array_fill_keys array_fill array_filter array_flip array_intersect_assoc array_intersect_key array_intersect_uassoc array_intersect_ukey array_intersect array_key_exists array_keys array_map array_merge_recursive array_merge array_multisort array_pad array_pop array_product array_push array_rand array_reduce array_replace array_replace_recursive array_reverse array_search array_shift array_slice array_splice array_sum array_udiff_assoc array_udiff_uassoc array_udiff array_uintersect_assoc array_uintersect_uassoc array_uintersect array_unique array_unshift array_values array_walk_recursive array_walk arsort asort compact count current each end extract in_array key krsort ksort natcasesort natsort next pos prev range reset rsort shuffle sizeof sort uasort uksort usort
  ...
  syn keyword phpFunctions contained class_alias class_exists get_called_class get_class_methods get_class_vars get_class get_declared_classes get_declared_interfaces get_object_vars get_parent_class interface_exists is_a is_subclass_of method_exists property_exists
  ...
  syn keyword phpFunctions contained checkdate date_add date_create date_create_from_format date_date_set date_default_timezone_get date_default_timezone_set date_diff date_format date_get_last_errors date_isodate_set date_modify date_offset_get date_parse date_parse_from_format date_sub date_sun_info date_sunrise date_sunset date_time_set date_timezone_get date_timezone_set date getdate gettimeofday gmdate gmmktime gmstrftime idate localtime microtime mktime strftime strptime strtotime time timezone_abbreviations_list timezone_identifiers_list timezone_name_from_abbr timezone_name_get timezone_offset_get timezone_open timezone_transitions_get timezone_version_get
  syn keyword phpClasses contained DateTime DateTimeZone DateInterval DatePeriod
  ...
  " error-handling
  syn keyword phpCoreConstant contained E_ERROR E_WARNING E_PARSE E_NOTICE E_CORE_ERROR E_CORE_WARNING E_COMPILE_ERROR E_COMPILE_WARNING E_USER_ERROR E_USER_WARNING E_USER_NOTICE E_USER_DEPRECATED E_STRICT E_RECOVERABLE_ERROR E_ALL
  ...
  " Fileinfo functions
  syn keyword phpCoreConstant contained FILEINFO_NONE FILEINFO_SYMLINK FILEINFO_MIME_TYPE FILEINFO_MIME_ENCODING FILEINFO_MIME FILEINFO_COMPRESS FILEINFO_DEVICES FILEINFO_CONTINUE FILEINFO_PRESERVE_ATIME FILEINFO_RAW
  ...
  syn keyword phpFunctions contained call_user_func_array call_user_func create_function forward_static_call forward_static_call_array func_get_arg func_get_args func_num_args function_exists get_defined_functions register_shutdown_function register_tick_function unregister_tick_function
  ...
  syn keyword phpFunctions contained hash_algos hash_copy hash_file hash_final hash_hmac_file hash_hmac hash_init hash_update_file hash_update_stream hash_update hash
  ...
  " JSON functions
  syn keyword phpCoreConstant contained JSON_ERROR_CTRL_CHAR JSON_ERROR_DEPTH JSON_ERROR_NONE JSON_ERROR_STATE_MISMATCH JSON_ERROR_SYNTAX JSON_FORCE_OBJECT JSON_HEX_TAG JSON_HEX_AMP JSON_HEX_APOS JSON_HEX_QUOT
  syn keyword phpFunctions contained json_decode json_encode json_last_error
  ...
  " LDAP functions
  syn keyword phpCoreConstant contained LDAP_DEREF_NEVER LDAP_DEREF_SEARCHING LDAP_DEREF_FINDING LDAP_DEREF_ALWAYS LDAP_OPT_DEREF LDAP_OPT_SIZELIMIT LDAP_OPT_TIMELIMIT LDAP_OPT_NETWORK_TIMEOUT LDAP_OPT_PROTOCOL_VERSION LDAP_OPT_ERROR_NUMBER LDAP_OPT_REFERRALS LDAP_OPT_RESTART LDAP_OPT_HOST_NAME LDAP_OPT_ERROR_STRING LDAP_OPT_MATCHED_DN LDAP_OPT_NETWORK_TIMEOUT LDAP_OPT_SERVER_CONTROLS LDAP_OPT_CLIENT_CONTROLS LDAP_OPT_DEBUG_LEVEL GSLC_SSL_NO_AUTH GSLC_SSL_ONEWAY_AUTH GSLC_SSL_TWOWAY_AUTH
  ...
  syn keyword	phpFunctions	array_change_key_case array_chunk array_combine array_count_values array_diff_assoc array_diff_uassoc array_diff array_fill array_filter array_flip array_intersect_assoc array_intersect array_key_exists array_keys array_map array_merge_recursive array_merge array_multisort array_pad array_pop array_push array_rand array_reduce array_replace array_replace_recursive array_reverse array_search array_shift array_slice array_splice array_sum array_udiff_assoc array_udiff_uassoc array_udiff array_unique array_unshift array_values array_walk arsort asort compact count current each end extract in_array key krsort ksort natcasesort natsort next pos prev range reset rsort shuffle sizeof sort uasort uksort usort	contained
  ...
  syn keyword	phpFunctions	call_user_method_array call_user_method class_alias class_exists get_called_class get_class_methods get_class_vars get_class get_declared_classes get_object_vars get_parent_class is_a is_subclass_of method_exists property_exists contained
  ...
  syn keyword	phpFunctions	basename chgrp chmod chown clearstatcache copy delete dirname disk_free_space disk_total_space diskfreespace fclose feof fflush fgetc fgetcsv fgets fgetss file_exists file_get_contents file_put_contents file fileatime filectime filegroup fileinode filemtime fileowner fileperms filesize filetype flock fnmatch fopen fpassthru fputs fread fscanf fseek fstat ftell ftruncate fwrite glob is_dir is_executable is_file is_link is_readable is_uploaded_file is_writable is_writeable link linkinfo lstat mkdir move_uploaded_file parse_ini_file parse_ini_string pathinfo pclose popen readfile readlink realpath rename rewind rmdir set_file_buffer stat symlink tempnam tmpfile touch umask unlink	contained
  ...
  syn keyword	phpFunctions	call_user_func_array call_user_func create_function forward_static_call forward_static_call_array func_get_arg func_get_args func_num_args function_exists get_defined_functions register_shutdown_function register_tick_function unregister_tick_function	contained
  ...
  syn keyword	phpFunctions	gmp_abs gmp_add gmp_and gmp_clrbit gmp_cmp gmp_com gmp_div_q gmp_div_qr gmp_div_r gmp_div gmp_divexact gmp_fact gmp_gcd gmp_gcdext gmp_hamdist gmp_init gmp_intval gmp_invert gmp_jacobi gmp_legendre gmp_mod gmp_mul gmp_neg gmp_or gmp_perfect_square gmp_popcount gmp_pow gmp_powm gmp_prob_prime gmp_random gmp_scan0 gmp_scan1 gmp_setbit gmp_sign gmp_sqrt gmp_sqrtrem gmp_sqrtrm gmp_strval gmp_sub gmp_testbit gmp_xor	contained
  syn keyword	phpFunctions	header header_remove headers_list headers_sent setcookie	contained
  ...
  syn keyword	phpFunctions	pcntl_exec pcntl_fork pcntl_signal pcntl_signal_dispatch pcntl_sigprocmask pcntl_sigtimedwait pcntl_sigwaitinfo pcntl_waitpid pcntl_wexitstatus pcntl_wifexited pcntl_wifsignaled pcntl_wifstopped pcntl_wstopsig pcntl_wtermsig	contained
  syn keyword	phpFunctions	preg_filter preg_grep preg_match_all preg_match preg_quote preg_replace_callback preg_replace preg_split	contained
...
syn keyword phpClasses contained containedin=phpRegion
    ...
    \ FilesystemIterator GlobIterator MultipleIterator RecursiveTreeIterator
...
if s:show_pcre
    ...
    " 6) Look for PCRE patterns {{{
      ...
      syn keyword phpPREGFunctions contained preg_filter preg_match preg_match_all preg_split preg_grep
